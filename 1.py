...
class Game:
    def _init_(self, master, player1, player2, Q_learn=None, Q={}, alpha=0.3, gamma=0.9):
        frame = tk.Frame()
        frame.grid()
        self.master = master
...
class Board:
    def _init_(self, grid=np.ones((3,3))*np.nan):
        self.grid = grid
...
class HumanPlayer(Player):
    def _init_(self, mark):
        super(HumanPlayer, self)._init_(mark=mark)

class ComputerPlayer(Player):
    def _init_(self, mark):
        super(ComputerPlayer, self)._init_(mark=mark)

class RandomPlayer(ComputerPlayer):
    def _init_(self, mark):
        super(RandomPlayer, self)._init_(mark=mark)
...
class THandPlayer(ComputerPlayer):
    def _init_(self, mark):
        super(THandPlayer, self)._init_(mark=mark)
...
class QPlayer(ComputerPlayer):
    def _init_(self, mark, Q={}, epsilon=0.2):
        super(QPlayer, self)._init_(mark=mark)
        self.Q = Q
